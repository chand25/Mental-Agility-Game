...
document.querySelector('#reset').addEventListener('click', startGame);
  ...
  document.querySelector('#cardfront_-1').addEventListener('click', startGame);
  document.querySelector('#cardfront_0').addEventListener('click', startGame);
  document.querySelector('#cardfront_1').addEventListener('click', startGame);
  document.querySelector('#cardfront_2').addEventListener('click', startGame);
  document.querySelector('#cardfront_3').addEventListener('click', startGame);
  document.querySelector('#cardfront_4').addEventListener('click', startGame);
  document.querySelector('#cardfront_5').addEventListener('click', startGame);
  document.querySelector('#cardfront_6').addEventListener('click', startGame);
  document.querySelector('#cardfront_7').addEventListener('click', startGame);
  document.querySelector('#cardfront_8').addEventListener('click', startGame);
  document.querySelector('#cardfront_9').addEventListener('click', startGame);
  document.querySelector('#cardfront_10').addEventListener('click', startGame);
  $('#cardfront_12').on('click', startGame);
  $('#cardfront_13').on('click', startGame);
  $('#cardfront_14').on('click', startGame);
  $('#cardfront_15').on('click', startGame);
  $('#cardfront_16').on('click', startGame);
  $('#cardfront_17').on('click', startGame);
  $('#cardfront_18').on('click', startGame);
  $('#cardfront_19').on('click', startGame);
  $('#cardfront_20').on('click', startGame);
  $('#cardfront_21').on('click', startGame);
  $('#cardfront_22').on('click', startGame);
  $('#cardfront_23').on('click', startGame);
};
